...
class OPO_Scraper(BaseScraper):

    airportName_ = "Porto Francisco de Sá Carneiro Airport"
    airportCode_ = "OPO"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/opo/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/opo/arrivals", headers=headers)  #(url=None, headers=None, method=None):
