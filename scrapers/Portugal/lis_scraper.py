...
class LIS_Scraper(BaseScraper):

    airportName_ = "Lisbon Airport"
    airportCode_ = "LIS"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/lis/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/lis/arrivals", headers=headers)  #(url=None, headers=None, method=None):
