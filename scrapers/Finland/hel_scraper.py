...
class HEL_Scraper(BaseScraper):

    airportName_ = "Helsinki Airport"
    airportCode_ = "HEL"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/hel/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/hel/arrivals", headers=headers)  #(url=None, headers=None, method=None):
