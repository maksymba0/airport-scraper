...
class RVN_Scraper(BaseScraper):

    airportName_ = "Rovaniemi Airport"
    airportCode_ = "RVN"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/rvn/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/rvn/arrivals", headers=headers)  #(url=None, headers=None, method=None):
