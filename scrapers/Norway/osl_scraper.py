...
class OSL_Scraper(BaseScraper):

    airportName_ = "Oslo Airport"
    airportCode_ = "OSL"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/osl/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/osl/arrivals", headers=headers)  #(url=None, headers=None, method=None):
