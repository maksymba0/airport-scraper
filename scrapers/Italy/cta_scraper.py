...
class CTA_Scraper(BaseScraper):

    airportName_ = "Catania Airport"
    airportCode_ = "CTA"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/cta/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/cta/arrivals", headers=headers)  #(url=None, headers=None, method=None):
