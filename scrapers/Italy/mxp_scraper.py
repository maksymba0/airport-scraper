...
class MXP_Scraper(BaseScraper):

    airportName_ = "Milan-Malpensa Airport"
    airportCode_ = "MXP"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/mxp/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/mxp/arrivals", headers=headers)  #(url=None, headers=None, method=None):
