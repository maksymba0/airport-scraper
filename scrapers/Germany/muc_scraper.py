...
class MUC_Scraper(BaseScraper):

    airportName_ = "Munich Airport"
    airportCode_ = "MUC"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/muc/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/muc/arrivals", headers=headers)  #(url=None, headers=None, method=None):
