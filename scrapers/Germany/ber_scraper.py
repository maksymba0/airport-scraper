...
class BER_Scraper(BaseScraper):

    airportName_ = "Berlin Airport"
    airportCode_ = "BER"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/ber/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/ber/arrivals", headers=headers)  #(url=None, headers=None, method=None):
