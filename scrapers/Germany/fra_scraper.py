...
class FRA_Scraper(BaseScraper):

    airportName_ = "Frankfurt International Airport"
    airportCode_ = "FRA"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/fra/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/fra/arrivals", headers=headers)  #(url=None, headers=None, method=None):
