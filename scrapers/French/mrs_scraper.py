...
class MRS_Scraper(BaseScraper):

    airportName_ = "Marseille Airport"
    airportCode_ = "MRS"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/mrs/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/mrs/arrivals", headers=headers)  #(url=None, headers=None, method=None):
