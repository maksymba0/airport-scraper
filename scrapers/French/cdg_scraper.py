...
class CDG_Scraper(BaseScraper):

    airportName_ = "Paris Charles de Gaulle Airport"
    airportCode_ = "CDG"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/cdg/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/cdg/arrivals", headers=headers)  #(url=None, headers=None, method=None):
