...
class NCE_Scraper(BaseScraper):

    airportName_ = "Nice Airport"
    airportCode_ = "NCE"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/nce/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/nce/arrivals", headers=headers)  #(url=None, headers=None, method=None):
