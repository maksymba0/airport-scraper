...
class BVA_Scraper(BaseScraper):

    airportName_ = "Paris Beauvais Airport"
    airportCode_ = "BVA"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/bva/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/bva/arrivals", headers=headers)  #(url=None, headers=None, method=None):
