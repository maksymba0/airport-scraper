...
class TLS_Scraper(BaseScraper):

    airportName_ = "Toulouse Airport"
    airportCode_ = "TLS"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/tls/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/tls/arrivals", headers=headers)  #(url=None, headers=None, method=None):
