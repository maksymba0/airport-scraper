...
class BCN_Scraper(BaseScraper):
    ...
    airportName_ = "Barcelona El Prat Josep Tarradellas Airport"
    airportCode_ = "BCN"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.aeropuertobarcelona-elprat.com/ingl/barcelona_airport_departures.html", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.aeropuertobarcelona-elprat.com/ingl/barcelona_airport_arrivals.html")  #(url=None, headers=None, method=None):
