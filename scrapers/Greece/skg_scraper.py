...
class SKG_Scraper(BaseScraper):

    airportName_ = "Thessaloniki Airport"
    airportCode_ = "SKG"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/skg/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/skg/arrivals", headers=headers)  #(url=None, headers=None, method=None):
