...
class ATH_Scraper(BaseScraper):

    airportName_ = "Athens Airport"
    airportCode_ = "ATH"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/ath/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/ath/arrivals", headers=headers)  #(url=None, headers=None, method=None):
