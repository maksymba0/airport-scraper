...
class CPH_Scraper(BaseScraper):

    airportName_ = "Copenhagen Airport"
    airportCode_ = "CPH"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/cph/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/cph/arrivals", headers=headers)  #(url=None, headers=None, method=None):
