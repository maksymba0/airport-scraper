...
class AAR_Scraper(BaseScraper):

    airportName_ = "Aarhus Airport"
    airportCode_ = "AAR"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/aar/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/aar/arrivals", headers=headers)  #(url=None, headers=None, method=None):
