...
class BLL_Scraper(BaseScraper):

    airportName_ = "Billund Airport"
    airportCode_ = "BLL"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/bll/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/bll/arrivals", headers=headers)  #(url=None, headers=None, method=None):
