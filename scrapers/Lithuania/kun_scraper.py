...
class KUN_Scraper(BaseScraper):

    airportName_ = "Kaunas Airport"
    airportCode_ = "KUN"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/kun/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/kun/arrivals", headers=headers)  #(url=None, headers=None, method=None):
