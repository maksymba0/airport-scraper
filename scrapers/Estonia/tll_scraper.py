...
class TLL_Scraper(BaseScraper):

    airportName_ = "Tallinn Airport"
    airportCode_ = "TLL"
    ...
    def getDepartures(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/tll/departures", headers=headers)  #(url=None, headers=None, method=None):
    ...
    def getArrivals(self):
        ...
        data = self.makeRequestHTML("https://www.avionio.com/widget/en/tll/arrivals", headers=headers)  #(url=None, headers=None, method=None):
